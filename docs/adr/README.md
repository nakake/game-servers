...
| [0003](0003-magic-link-auth.md) | 管理 WebUI の認証に Discord magic link 方式を採用する | Accepted |
| [0004](0004-admin-webui-separate-worker.md) | 管理 WebUI を discord-handler とは別の Worker に分離する | Accepted |
